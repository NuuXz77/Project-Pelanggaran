...
<div class="min-h-screen flex items-center justify-center bg-cover bg-center px-4 sm:px-6">
    <div class="bg-base-100 p-6 sm:p-10 rounded-md shadow-lg w-full max-w-md">
        ...
        @if (session('error'))
            <x-alert title="Login Gagal" description="{{ session('error') }}" class="alert-error"
