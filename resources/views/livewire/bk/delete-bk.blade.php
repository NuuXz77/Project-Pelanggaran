...
new class extends Component {
    ...
    public function deleteBk()
    {
        ...
        $this->toast('success', 'Sukses!', 'Data akun BK berhasil dihapus');
...
<div>
    <x-mary-modal wire:model="deleteModal" title="Hapus Akun BK" persistent class="backdrop-blur">
        ...
        <x-slot:actions>
            ...
            <x-button label="Hapus" wire:click="deleteBk" class="btn-error" spinner="deleteBk" />
        </x-slot:actions>
    </x-mary-modal>
</div>
