...
new class extends Component {
    ...
    public function simpanPKS()
    {
        ...
        $this->toast('success', 'Sukses!', 'Akun PKS berhasil ditambahkan');
...
<div>
    ...
    <x-modal wire:model="modalTambah" title="Tambah Akun PKS" subtitle="Isi informasi akun PKS" separator persistent>
        <x-form wire:submit="simpanPKS">
            ...
            <x-slot:actions>
                ...
                <x-button label="Simpan" type="submit" class="btn-primary" spinner="simpanPKS" />
            </x-slot:actions>
        </x-form>
    </x-modal>
</div>
