...
new class extends Component {
    ...
    public function deleteGURU()
    {
        ...
        $this->toast('success', 'Sukses!', 'Data akun GURU berhasil dihapus');
...
<div>
    <x-mary-modal wire:model="deleteModal" title="Hapus Akun GURU" persistent class="backdrop-blur">
        ...
        <x-slot:actions>
            ...
            <x-button label="Hapus" wire:click="deleteGURU" class="btn-error" spinner="deleteGURU" />
        </x-slot:actions>
    </x-mary-modal>
</div>
