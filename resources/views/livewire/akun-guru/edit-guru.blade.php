...
new class extends Component {
    ...
    public function updateGURU()
    {
        ...
        $this->toast('success', 'Berhasil!', 'Data akun GURU berhasil diperbarui');
...
<div>
    <x-modal wire:model="modalEdit" title="Edit Akun GURU" subtitle="Perbarui informasi akun GURU" separator persistent>
