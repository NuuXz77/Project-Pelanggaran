    ...
    <x-nav sticky full-width>
        ...
        <x-slot:brand>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="font-semibold">Siska</span>
        ...
        @if ($user = auth()->user())
            <x-slot:actions>
                ...
                <x-avatar :placeholder="collect(explode(' ', auth()->user()->name))
                    ...
                    ->take(2)
                    ->implode('')" title="{{ auth()->user()->name }}" subtitle="{{ auth()->user()->email }}"
                    class="!w-10" />
                <x-dropdown no-x-anchor right>
                    ...
                    <x-menu-item title="Profile" link="/profile" wire:navigate />
            ...
            <x-slot:sidebar drawer="main-drawer" collapsible>
                ...
                <x-menu activate-by-route>
                    ...
                    @if ($user->isKesiswaan())
                        ...
                        <x-menu-item title="Tindakan" icon="o-clipboard-document-check" link="/tindakan" />
                        <x-menu-item title="Pelanggaran" icon="o-exclamation-triangle" link="/pelanggaran" />
                        {{-- <x-menu-item title="Data Guru" icon="o-academic-cap" link="/data-guru" /> --}}
                        <x-menu-item title="Data Kelas" icon="o-building-library" link="/data-kelas" />
                        ...
                        <x-menu-sub title="Manajemen Akun" icon="o-cog-6-tooth">
                            ...
                            <x-menu-item title="Guru" icon="o-academic-cap" link="/akun-guru" />
                        </x-menu-sub>
                        <x-menu-item title="Log Aktivitas" icon="o-clipboard-document-list" link="/log-aktivitas" />
                    @endif
                    ...
                    @if ($user->isPKS())
                        {{-- <x-menu-item title="Beranda" icon="o-home" link="/" /> --}}
                        <x-menu-item title="Input Pelanggaran" icon="o-clipboard-document-check"
                            link="/input-pelanggar" />
                        <x-menu-item title="Siswa Kesiangan" icon="o-clock" link="/siswa-kesiangan" />
